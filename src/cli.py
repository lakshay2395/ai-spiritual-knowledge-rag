...
def phoenix(port: int):
    ...
    try:
        ...
        console.print(f"[bold green]Starting Arize Phoenix on port {port}...[/bold green]")
        ...
        console.print("[bold red]Error:[/bold red] arize-phoenix not installed. Run 'pip install arize-phoenix'.")
    except Exception as e:
