...
class QueryRequest(BaseModel):
    query: str = Field(..., json_schema_extra={"example": "What does Krishna say about duty?"})
    religion: Optional[str] = Field(None, json_schema_extra={"example": "bhagavad_gita"})
...
async def ask(request: QueryRequest):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Internal server error occurred while processing the query.")
