...
class TestIndexing:
    ...
    def temp_data_dir(self):
        ...
        data = [
            {"text": "In the beginning God created the heaven and the earth.", "metadata": {"book": "Genesis", "chapter": "1", "verse": "1"}},
            {"text": "And the earth was without form, and void.", "metadata": {"book": "Genesis", "chapter": "1", "verse": "2"}}
        ]
